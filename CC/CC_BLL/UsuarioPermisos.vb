...
Public Class UsuarioPermisos
    ...
    Private _usuarioPermsisosAdapter As usuario_patternTableAdapter
    ...
    Public Property Adapter() As usuario_patternTableAdapter
        Get
            If _usuarioPermsisosAdapter Is Nothing Then
                _usuarioPermsisosAdapter = New usuario_patternTableAdapter()
            End If
            Return _usuarioPermsisosAdapter
        End Get
        Set(ByVal value As usuario_patternTableAdapter)
            _usuarioPermsisosAdapter = value
        End Set
    End Property
    ...
    Public Function UpdateSelected(ByVal id_usuario As Long, ByVal PermisosToAdd As String, ByVal PermisosToRemove As String) As Long
        ...
        If (PermisosToRemove.Length > 0) Then
            ...
            Next
        End If
        Log.Record("UsuarioPermisos.UpdateSelected", _idUsuarioActual, id_usuario, PermisosToAdd, PermisosToRemove)
        Return res
    End Function
    ...
    Public Overloads Function Add(ByVal id_usuario As Long, ByVal id_patt As Long) As Long
        ...
        If Not SetCheckSum_e(Adapter.GetDataById(id)) Then
            id = 0
        End If
        Log.Record("UsuarioPermisos.Add", _idUsuarioActual, id_usuario, id_patt)
        Return id
    End Function
    ...
    Public Overloads Function Delete(ByVal id_usuario As Long, ByVal id_patt As Long) As Boolean
        ...
        dt.Rows(0).Delete()
        Log.Record("UsuarioPermisos.Delete", _idUsuarioActual, id_usuario, id_patt)
    ...
    Public Function GetDataById(ByVal id As Integer, Optional ByVal validate As Boolean = True) As DataTable
        ...
        End If
        Log.Record("UsuarioPermisos.GetDataById", _idUsuarioActual, id)
        Return dt
    End Function
